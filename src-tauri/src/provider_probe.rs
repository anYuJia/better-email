    ...
    let mut statement = connection
        .prepare(
            "SELECT id, email, display_name, provider, imap_host, smtp_host,
                    ...
                    signature, cross_account_risk_warning, block_external_mailboxes, intercept_https_links, auto_download_attachments, is_default
        ...
        connection
            .execute_batch(
                ...
                INSERT INTO accounts VALUES(
                    ...
                    'imap', 'password', 'manual', 0, '', 1, 0, 1, 0, 1
                );",
            )
            .unwrap();
        drop(connection);
